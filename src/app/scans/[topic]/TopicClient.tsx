...
export default function TopicClient({ topic }: { topic: ScanTopic }) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {topic.scans.map((scan, idx) => (
            <motion.div
              ...
              className="bg-green-900/30 border border-green-700/30 rounded-xl p-4"
        ...
        {currentIndex !== null && topic.scans && (
          ...
          >
            <motion.div
              ...
              className="bg-green-950 border border-green-700 rounded-lg max-w-3xl w-full p-6"
            >
