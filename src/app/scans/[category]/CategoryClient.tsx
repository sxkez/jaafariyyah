// src/app/scans/[category]/CategoryClient.tsx (CLIENT)
"use client";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-950 via-emerald-950 to-black text-white px-6 py-12">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-2">{category}</h1>
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        {topics.map((topic) => (
          ...
          >
            <h2 className="text-xl font-semibold mb-2">{topic.term} • {topic.arabic}</h2>
